            ...
            <div id="wrapper">
                ...
                <div id="menu">
                    ...
                    <!--Fetching Names Of All Students From Database-->
                        <?php foreach ($students as $student): ?>
                            <li><a href="<?php echo base_url() . "index.php/zwei_update_ctrl_only/show_student_id/" . $student->W_ID . "/" . $student->P_ID; ?>">
                ...
                <div id="detail">
                    ...
                    <?php foreach ($single_student as $student): ?>
                        ...
                        <form method="post" action="<?php echo base_url() . "index.php/zwei_update_ctrl_only/update_student_id1"?>">
							<br/><br/>
