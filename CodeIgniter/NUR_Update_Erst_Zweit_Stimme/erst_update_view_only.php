            ...
            <div id="wrapper">
                ...
                <div id="menu">
					...
					<?php foreach ($students as $student): ?>
						<li><a href="<?php echo base_url() . "index.php/erst_update_ctrl_only/show_student_id/" . $student->W_ID . "/" . $student->D_ID; ?>">
							<?php echo $student->W_ID; ?> / <?php echo $student->D_ID; ?></a></li>
					<?php endforeach; ?>
					<p><a href="<?php echo base_url() . "index.php/navi_ctrl_nur_erst_zweit/load_navi_view"; ?>">Zurück zur Navigation</a><p/>
                </div>
                <div id="detail">
					<!--Fetching All Details of Selected Student From Database And Showing In a Form-->
                    <?php foreach ($single_student as $student): ?>
                        <p>Bearbeite die Daten & Klicke den 'Update' Button</p>
                        <form method="post" action="<?php echo base_url() . "index.php/erst_update_ctrl_only/update_student_id1"?>">
							<br/><br/>
